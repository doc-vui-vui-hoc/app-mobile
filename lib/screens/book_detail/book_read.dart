...
import 'package:ar_book/screens/book_detail/component/item_detail.dart';
...
class BookReadingState extends ConsumerState<BookReading> {
  ...
  String urlAudio(int index) {
    ...
    if (pages[index]["audio"][currentLang] != null) {
      playUrl = baseUrlAR + pages[index]["audio"][currentLang]["url"];
    } else {
      playUrl =
                  ...
                  return PopupMenuItem(
                    ...
                    child: Text(lang.name,
                        style: TextStyle(
                            ...
                            color: (currentLang == lang.slug)
                                ? Colors.red
                                : const Color(0xFF707070))),
                    enabled: currentLang != lang.slug,
                  );
                }).toList();
              }),
          FlutterSwitch(
