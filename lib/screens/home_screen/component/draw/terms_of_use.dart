  ...
  Widget _buildTextHtml(String title) {
    return Html(
      ...
      style: {
        ...
        "Strong": Style(
          margin: Margins.only(top: 16, bottom: 5),
          padding: HtmlPaddings.zero,
